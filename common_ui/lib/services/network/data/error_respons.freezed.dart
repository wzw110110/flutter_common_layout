...
abstract class $ErrorResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int errorCode, String? errorMsg});
}
...
class _$ErrorResponseImpl implements _ErrorResponse {
  const _$ErrorResponseImpl({required this.errorCode, this.errorMsg});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, errorCode, errorMsg);
...
abstract class _ErrorResponse implements ErrorResponse {
  const factory _ErrorResponse(
      ...
      final String? errorMsg}) = _$ErrorResponseImpl;
